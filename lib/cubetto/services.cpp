...
{
    return (lib_aci_set_local_data(&aci_state, PIPE_GAP_DEVICE_NAME_SET, (uint8_t *)gap_device_name_set,
                                   gap_device_name_set_size));
}
...
{
    return (
        lib_aci_set_local_data(&aci_state, PIPE_BATTERY_BATTERY_LEVEL_SET, (uint8_t *)&battery_battery_level_set, 1));
}
