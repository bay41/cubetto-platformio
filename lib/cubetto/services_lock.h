...
#define SERVICES_PIPE_TYPE_MAPPING_CONTENT                                                                             \
    {                                                                                                                  \
        {ACI_STORE_LOCAL, ACI_SET},         {ACI_STORE_LOCAL, ACI_TX},  {ACI_STORE_LOCAL, ACI_SET},                    \
        {ACI_STORE_LOCAL, ACI_RX_ACK_AUTO}, {ACI_STORE_LOCAL, ACI_TX},  {ACI_STORE_LOCAL, ACI_TX},                     \
        {ACI_STORE_LOCAL, ACI_TX},          {ACI_STORE_LOCAL, ACI_SET},                                                \
    }

#define GAP_PPCP_MAX_CONN_INT                                                                                          \
    0xc8 /**< Maximum connection interval as a multiple of 1.25 msec , 0xFFFF means no specific value requested */
#define GAP_PPCP_MIN_CONN_INT                                                                                          \
    0xa0 /**< Minimum connection interval as a multiple of 1.25 msec , 0xFFFF means no specific value requested */
#define GAP_PPCP_SLAVE_LATENCY 0
#define GAP_PPCP_CONN_TIMEOUT                                                                                          \
    0xffff /** Connection Supervision timeout multiplier as a multiple of 10msec, 0xFFFF means no specific value       \
              requested */
 ...
 *  @return : true if is_freshest_sample true, otherwise return false if a transaction on this pipe is already pending,
 * true otherwise.
 */
 ...
 *  @param src the value to send
 *  @details use this function to do a set_local_data for PIPE_BATTERY_BATTERY_LEVEL_SET. If no transaction are
 * currently running, the set will be immediate, otherwise, it will be done at the end of the current transaction when
 * services_update_pipes will be called.
 */
...
#define SETUP_MESSAGES_CONTENT                                                                                         \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x08, 0x00, 0x01, 0x00,        \
                0x00, 0x06, 0x00, 0x01, 0x90, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x10, 0x1c, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,        \
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x03, 0x90, 0x01, 0xff,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x10, 0x38, 0xff, 0xff, 0x02, 0x58, 0x0a, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,        \
        ...
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x20, 0x00, 0x04, 0x04, 0x02, 0x02, 0x00, 0x01, 0x28, 0x00, 0x01, 0x00, 0x18, 0x04,        \
                0x04, 0x05, 0x05, 0x00, 0x02, 0x28, 0x03, 0x01, 0x0e, 0x03, 0x00, 0x00, 0x2a, 0x04, 0x14, 0x0c,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x20, 0x1c, 0x07, 0x00, 0x03, 0x2a, 0x00, 0x01, 0x43, 0x75, 0x62, 0x65, 0x74, 0x74,        \
                0x6f, 0x65, 0x6d, 0x69, 0x2e, 0x63, 0x04, 0x04, 0x05, 0x05, 0x00, 0x04, 0x28, 0x03, 0x01, 0x02,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x20, 0x38, 0x05, 0x00, 0x01, 0x2a, 0x06, 0x04, 0x03, 0x02, 0x00, 0x05, 0x2a, 0x01,        \
                0x01, 0x00, 0x00, 0x04, 0x04, 0x05, 0x05, 0x00, 0x06, 0x28, 0x03, 0x01, 0x02, 0x07, 0x00, 0x04,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x20, 0x54, 0x2a, 0x06, 0x04, 0x09, 0x08, 0x00, 0x07, 0x2a, 0x04, 0x01, 0xa0, 0x00,        \
                0xc8, 0x00, 0x00, 0x00, 0xff, 0xff, 0x04, 0x04, 0x02, 0x02, 0x00, 0x08, 0x28, 0x00, 0x01, 0x01,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x20, 0x70, 0x18, 0x04, 0x04, 0x02, 0x02, 0x00, 0x09, 0x28, 0x00, 0x01, 0x0f, 0x18,        \
                0x04, 0x04, 0x05, 0x05, 0x00, 0x0a, 0x28, 0x03, 0x01, 0x12, 0x0b, 0x00, 0x19, 0x2a, 0x16, 0x04,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x20, 0x8c, 0x02, 0x01, 0x00, 0x0b, 0x2a, 0x19, 0x01, 0x10, 0x46, 0x14, 0x03, 0x02,        \
                0x00, 0x0c, 0x29, 0x02, 0x01, 0x00, 0x00, 0x04, 0x04, 0x10, 0x10, 0x00, 0x0d, 0x28, 0x00, 0x01,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x20, 0xa8, 0x13, 0x15, 0x5c, 0xd6, 0xda, 0xbf, 0x3f, 0x8b, 0x0a, 0x46, 0x52, 0xff,        \
                0x00, 0x00, 0x84, 0x02, 0x04, 0x04, 0x13, 0x13, 0x00, 0x0e, 0x28, 0x03, 0x01, 0x0a, 0x0f, 0x00,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x20, 0xc4, 0x13, 0x15, 0x5c, 0xd6, 0xda, 0xbf, 0x3f, 0x8b, 0x0a, 0x46, 0x52, 0xff,        \
                0x01, 0x00, 0x84, 0x02, 0x46, 0x14, 0x05, 0x04, 0x00, 0x0f, 0x00, 0x01, 0x02, 0x00, 0x00, 0x00,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x20, 0xe0, 0x00, 0x04, 0x04, 0x13, 0x13, 0x00, 0x10, 0x28, 0x03, 0x01, 0x12, 0x11,        \
                0x00, 0x13, 0x15, 0x5c, 0xd6, 0xda, 0xbf, 0x3f, 0x8b, 0x0a, 0x46, 0x52, 0xff, 0x02, 0x00, 0x84,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x20, 0xfc, 0x02, 0x16, 0x04, 0x05, 0x04, 0x00, 0x11, 0x00, 0x02, 0x02, 0x00, 0x00,        \
                0x00, 0x00, 0x46, 0x14, 0x03, 0x02, 0x00, 0x12, 0x29, 0x02, 0x01, 0x00, 0x00, 0x04, 0x04, 0x13,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x21, 0x18, 0x13, 0x00, 0x13, 0x28, 0x03, 0x01, 0x12, 0x14, 0x00, 0x13, 0x15, 0x5c,        \
                0xd6, 0xda, 0xbf, 0x3f, 0x8b, 0x0a, 0x46, 0x52, 0xff, 0x03, 0x00, 0x84, 0x02, 0x16, 0x04, 0x08,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x21, 0x34, 0x07, 0x00, 0x14, 0x00, 0x03, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,        \
                0x00, 0x46, 0x14, 0x03, 0x02, 0x00, 0x15, 0x29, 0x02, 0x01, 0x00, 0x00, 0x04, 0x04, 0x13, 0x13,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x21, 0x50, 0x00, 0x16, 0x28, 0x03, 0x01, 0x12, 0x17, 0x00, 0x13, 0x15, 0x5c, 0xd6,        \
                0xda, 0xbf, 0x3f, 0x8b, 0x0a, 0x46, 0x52, 0xff, 0x04, 0x00, 0x84, 0x02, 0x14, 0x04, 0x14, 0x01,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x21, 0x6c, 0x00, 0x17, 0x00, 0x04, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,        \
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46, 0x14, 0x03,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
        ...
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x40, 0x00, 0x2a, 0x00, 0x01, 0x00, 0x80, 0x04, 0x00, 0x03, 0x00, 0x00, 0x2a, 0x19,        \
                0x01, 0x00, 0x82, 0x04, 0x00, 0x0b, 0x00, 0x0c, 0x00, 0x01, 0x02, 0x04, 0x00, 0x04, 0x00, 0x0f,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x1f, 0x06, 0x40, 0x1c, 0x00, 0x00, 0x00, 0x02, 0x02, 0x00, 0x02, 0x04, 0x00, 0x11, 0x00, 0x12,        \
                0x00, 0x03, 0x02, 0x00, 0x02, 0x04, 0x00, 0x14, 0x00, 0x15, 0x00, 0x04, 0x02, 0x00, 0x82, 0x04,        \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
        ...
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x13, 0x06, 0x50, 0x00, 0x13, 0x15, 0x5c, 0xd6, 0xda, 0xbf,                                            \
                0x3f, 0x8b, 0x0a, 0x46, 0x52, 0xff, 0x00, 0x00, 0x84, 0x02,                                            \
            },                                                                                                         \
        },                                                                                                             \
        {                                                                                                              \
            0x00,                                                                                                      \
            {                                                                                                          \
                0x15, 0x06, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                                      \
